...
def list_assignments(p):
    ...
    work = []
    for letter in teachers_assignments_dump:
        if(letter['teacher_id'] == p):
            work.append(letter)
    return APIResponse.respond(data=work)
...
def grade_assignment(p, incoming_payload):
    ...
    assertions.assert_auth(p.teacher_id == assignment.teacher_id,"Assignment submitted to another teacher")
